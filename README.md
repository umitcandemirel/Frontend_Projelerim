...
[TR] Bu depo, modern web geliştirme standartlarını kavrama ve uygulama süreçlerimi içeren bir portfolyo niteliğindedir.
[EN] This repository is a portfolio of my journey in mastering and implementing modern web development standards.
...
* **[Görsel Uygulamaları](./01-HTML5/images.html):** Web uyumlu görsel kullanımı ve attribute yönetimi.
...
| Technology / Teknoloji | Level / Seviye | Status / Durum |
| :--- | :--- | :--- |
| **HTML5** | Advanced / İleri | ✅ Completed |
| **Git & GitHub** | Intermediate / İyi | 🔄 In Progress |
| **Figma** | Design / Tasarım | 📅 Starting Tomorrow |
| **CSS3** | Styling / Stil | 📅 Coming Soon |
